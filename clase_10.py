...
# def mi_len(coleccion_datos):
#     contador = 0
#     for letra in coleccion_datos:
#         contador += 1
#     return contador
...
# def mostrar_texto(*frases):
#     # print(args)
#     print(' '.join(frases))
#     # print(valor1, valor2, valor3)


# mostrar_texto('soy pepito', 'y corro en maratones.', 'Tambien participo de triatlones.')
# mostrar_texto('Quien te conoce', 'maestro')
# mostrar_texto('Richi!')
...
# mostrar_datos(nombrecito='Pepito', apellido='Grillo')
# mostrar_datos(nombre='Ricardo', mostro='Fort', anios=45)



# def mostrar_datos(dato_suelto, *frases, **kwargs):
#     print(' '.join(frases))
#     for clave, valor in kwargs.items():
#         print(f'{clave} -> {valor}')

# mostrar_datos('soy pepito', 'y corro en maratones.', 'Tambien participo de triatlones.', nombrecito='Pepito', apellido='Grillo')
# mostrar_datos('Richi!', nombre='Ricardo', mostro='Fort', anios=45)
...
def funcion_magica(*valores):
    print(valores)
    if len(valores) == 1:
        milimetros = valores[0]
        metros = milimetros // 1000
        resta_milimetros = milimetros%1000
        centimetros = resta_milimetros // 10
        resta_milimetros = resta_milimetros % 10    
        print(f'Teniendo {milimetros} milimetros... Tendriamos {metros} metros, {centimetros} centimetros y {resta_milimetros} milimetros.')
    elif len(valores) == 3:
        metros = valores[0]
        centimetros = valores[1]
        milimetros = valores[2]
        total_milimetros = metros*1000 + centimetros * 10 + milimetros
        print(f'Teniendo {metros} metros, {centimetros} centimetros y {milimetros} milimetros... Llegariamos a tener {total_milimetros} milimetros en total.')
    else:
        print('No es correcta la cantidad de datos brindada.')
    

funcion_magica(5555)
funcion_magica(5,55,5)
funcion_magica(5,55,5,54)